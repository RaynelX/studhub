...
-- ============================================================
-- RLS: читают все (anon), пишет только авторизованный староста.
-- Если в проекте политики названы иначе — привести к тому же виду,
-- что у public.subjects / public.teachers.
-- ============================================================
